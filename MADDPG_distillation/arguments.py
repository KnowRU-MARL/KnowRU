...
def parse_args():
    ...
    # environment
    parser.add_argument("--scenario_name", type=str, default="simple_spread6", help="name of the scenario script")
    ...
    parser.add_argument("--max_episode", type=int, default=3000, help="maximum episode length")
    parser.add_argument("--num-adversaries", type=int, default=0, help="number of adversaries")

    # core training parameters
    parser.add_argument("--device", default=device, help="torch device ")
    parser.add_argument("--learning_start_step", type=int, default=12500, help="learning start steps")
    ...
    parser.add_argument("--start_save_model", type=int, default=500, help="the number of the episode for saving the model")
    ...
    # base_model
    parser.add_argument("--base_model_dir", type=str, default="base_models/", help="base_model路径")
    parser.add_argument("--base_model_name", type=list, default=['a_c_0.pt','a_c_1.pt','a_c_2.pt','a_c_3.pt','a_c_0.pt','a_c_1.pt'], help="base_model名字")
    parser.add_argument("--alpha", type=float, default="0.5", help="actor_loss的比例")

    #show-time
    parser.add_argument("--print", type=int, default="100", help="每过多久plot一次")
