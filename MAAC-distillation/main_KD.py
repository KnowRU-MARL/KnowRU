...
if __name__ == '__main__':
    ...
    parser.add_argument("--base_model_name", type=list,
                        default=['a_c_0.pt', 'a_c_1.pt', 'a_c_2.pt', 'a_c_3.pt', 'a_c_4.pt', 'a_c_5.pt', 'a_c_6.pt',
                                 'a_c_7.pt'], help="base_model名字,CTC")

    # parser.add_argument("--base_model_name", type=list,
    #                     default=['a_c_0.pt', 'a_c_1.pt', 'a_c_2.pt', 'a_c_0.pt', 'a_c_3.pt', 'a_c_4.pt', 'a_c_5.pt',
    #                              'a_c_3.pt'], help="base_model名字,RT")
